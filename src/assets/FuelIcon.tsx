export default function FuelIcon({ className }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <rect
        ...
        strokeLinejoin="round"
      />
      <path d="M6 21H21.1111" stroke="currentColor" strokeWidth="0.944444" strokeLinecap="round" />
    </svg>
  )
}
